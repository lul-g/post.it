...
function page() {
  return (
    <div className="h-full bg-slate-100 flex flex-col items-center p-5 gap-5">
      <span className="text-black text-center text-3xl font-bold p-5 rounded-lg bg-white h-fit">
        Its a posting app, go post stuff❗
      </span>
      <span className="text-black text-center text-2xl font-bold p-5 rounded-lg bg-white h-fit">
        Found a bug 🐞?{" "}
